...
def run_camera(client):
    ...
    while True:
            ...
            if count > 0 :
                ...
                push_data = base64.b64encode(frame)  # convert to base64 format
                ...
                #     print("Publish image: ")
                #     print(len(data))
                #     client.publish('image-stream', data)
                count = count - 1
            ...
            feed_id= ("imask" if class_name[2:] == "mask" else "unmask")
            if count > 0:
                client.publish(feed_id, push_data)
